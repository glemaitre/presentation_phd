...
\begin{frame}
  ...
  \begin{block}{\small Heatmap representation\footnotemark}
    \begin{figure}%
...
\begin{frame}
  ...
  \begin{block}{\small Inter-patients variations}
      \begin{figure}%
        ...
        \hspace*{\fill}%
        \caption{Variations driven with $\Delta_i$, $\Delta_t$, and $\sigma_i$}
      \end{figure}
  \end{block}
\end{frame}
...
\begin{frame}
  ...
  \footcitetext{lemaitre2016normalization}
\end{frame}
...
\begin{frame}
  \frametitle{Experiments}
  \framesubtitle{DCE-MRI normalization\footnotemark}
  \footcitetext{lemaitre2017automatic}
\end{frame}
