...
\begin{frame}
  ...
  \begin{greenblock}{\small Pros}
    \begin{itemize}\scriptsize
    \item[\tick] Reduce CaP-related mortality between \SI{21}{\percent} to \SI{44}{\percent}\footnotemark
    \end{itemize}
  \end{greenblock}
  \begin{redblock}{\small Cons}
    \begin{itemize}\scriptsize
...
\begin{frame}
  ...
  \begin{block}{\small Quantitative and semi-quantitative models}
    \begin{figure}
      ...
      \hspace*{\fill}
      \caption{\tiny ROC analysis for pharmarcokinetic model}
    \end{figure}
  \end{block}
\end{frame}
...
\begin{frame}
  ...
  \begin{block}{\small Classification as fusion}
    \begin{itemize}\scriptsize
    \item RF used as classifier for each modality and aggregation of features
    \item Stacking of RF with an adaboost and gradient-boosting meta-classifier
    \end{itemize}
    \vspace*{-.3cm}
    \begin{figure}%
      \centering
      \includegraphics[height=.35\textheight]{./images/stacking_gb.png}
    \end{figure}
  \end{block}
...
\begin{frame}
  ...
  \begin{block}{\small Quantitative and semi-quantitative models}
    \begin{figure}
      \centering
      \hspace*{\fill}
      \subfigure[\tiny Without normalization]{\includegraphics[width=.48\textwidth]{images/DCE-normalization/unormalized_methods_0.pdf}}\hfill
      \subfigure[\tiny With normalization]{\includegraphics[width=.48\textwidth]{images/DCE-normalization/normalized_methods_0.pdf}}
      \hspace*{\fill}
      \caption{\tiny ROC analysis for pharmarcokinetic model}
    \end{figure}
  \end{block}
...
\begin{frame}
  ...
  \begin{block}{\small ROC analysis}
    \begin{figure}
      \centering
      \hspace*{\fill}
      \subfigure[\tiny T$_2$W-MRI and ADC]{\includegraphics[width=.48\textwidth]{images/exp-1/t2w_adc.pdf}}\hfill
      \subfigure[\tiny MRSI]{\includegraphics[width=.48\textwidth]{images/exp-1/mrsi_all.pdf}}
      \hspace*{\fill}
      \caption{\tiny ROC analysis for T$_2$W-MRI, ADC, and MRSI modalities}
    \end{figure}
  \end{block}
\end{frame}
  ...
  \only<2>{
    \begin{block}{\small ROC for each patient}
      \begin{figure}
        ...
        \caption{\tiny ROC analysis for each patient}
      \end{figure}
    \end{block}}
\end{frame}
...
\begin{frame}
  ...
  \framesubtitle{MRSI benefit}
    ...
    \begin{block}{\small Stacking with/without MRSI}
      \begin{figure}
        \centering
        \includegraphics[width=.6\textwidth]{images/exp-6/stacking_wt_mrsi.pdf}
        \caption{\tiny ROC analysis with/without MRSI}
      \end{figure}
    \end{block}
\end{frame}
