...
\begin{frame}
  ...
  \framesubtitle{Motivations\footnotemark}
  \only<1>{
...
\begin{frame}
  ...
  \begin{block}{\small DCE-MRI}
    \begin{figure}%
      \centering
      \includegraphics[width=.65\textwidth]{./images/mri/dce/dce_cancer_healthy_information.eps}
      \label{fig:dce}%
  ...
  \begin{columns}
    ...
    \begin{column}{0.5\textwidth}
      \begin{block}{\small Pros and cons}\footnotesize
        ...
        \item[\cross] Lower spatial resolution than T$_2$W-MRI
        \item[\cross] Difficult detection in CG
        \item[\cross] Variations of the curves between patients
        \end{itemize}
      \end{block}
    \end{column}
  \end{columns}
...
%%     \input{images/state/nb_modality.tex}
%%   \end{block}
%% \end{frame}

%%% The statistics of the state of the art 
\input{liter-statistics}
  ...
  \only<2>{
    \begin{block}{\small ROC for each patient}
      \begin{figure}
        ...
        \caption{\tiny Without MRSI: AUC = 0.756 / with MRSI - AUC = 0.786}
      \end{figure}
    \end{block}}
\end{frame}
